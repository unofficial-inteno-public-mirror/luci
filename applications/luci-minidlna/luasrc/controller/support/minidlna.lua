...
module("luci.controller.support.minidlna", package.seeall)
...
function index()
	...
	page = entry({"support", "services", "minidlna"}, cbi("admin_services/minidlna"), _("miniDLNA"))
	page.dependent = true

	entry({"support", "services", "minidlna_status"}, call("minidlna_status"))
end
