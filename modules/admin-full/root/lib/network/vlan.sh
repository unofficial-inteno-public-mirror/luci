...
# tags 1 rx	    
	    vlanctl --if  $baseifname --rx --tags 1  --filter-vid $vlan8021q 0 --pop-tag --set-rxif $ifname  --rule-insert-last
# tags 2 rx
	    vlanctl --if  $baseifname --rx --tags 2 --filter-vid $vlan8021q 0 --pop-tag --set-rxif $ifname  --rule-insert-last
