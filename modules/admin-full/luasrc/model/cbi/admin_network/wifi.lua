...
if hwtype == "broadcom" then
	...
	if bnd:match("b") then
		band:value("b-20", translate("2.4GHz | 20MHz Bandwidth"))
		band:value("b-40", translate("2.4GHz | 40MHz Bandwidth"))
	end
	if bnd:match("a") then
		band:value("a-20", translate("5GHz | 20MHz Bandwidth"))
		band:value("a-40", translate("5GHz | 40MHz Bandwidth"))
		if wdev:hwmodes().ac then 
			band:value("a-80", translate("5GHz | 80MHz Bandwidth"), {country="US"})
		end
	end

	mode = s:taboption("advanced", ListValue, "hwmode", translate("Mode"))
	mode:value("auto", "Auto", {band="b-20"})
	mode:value("11b", "802.11b", {band="b-20"})
	mode:value("11bg", "802.11b+g", {band="b-20"})
	mode:value("11g", "802.11g", {band="b-20"})
	mode:value("11gst", "802.11g + Turbo", {band="b-20"})
	mode:value("11lrs", "802.11 LRS", {band="b-20"})
	mode:value("11n", "802.11n", {band="b-20"}, {band="b-40"}, {band="a-20"}, {band="a-40"})
	if wdev:hwmodes().ac then 		
		mode:value("11ac", "802.11ac", {band="a-20"}, {band="a-40"}, {band="a-80"})
	end
...
--[[
	...
	ch:value("1", translate("1"), {band="b-20"})
	ch:value("2", translate("2"), {band="b-20"})
	ch:value("3", translate("3"), {band="b-20"})
	ch:value("4", translate("4"), {band="b-20"})
	ch:value("5", translate("5"), {band="b-20"})
	ch:value("6", translate("6"), {band="b-20"})
	ch:value("7", translate("7"), {band="b-20"})
	ch:value("8", translate("8"), {band="b-20"})
	ch:value("9", translate("9"), {band="b-20"})
	ch:value("10", translate("10"), {band="b-20"})
	ch:value("11", translate("11"), {band="b-20"})
	ch:value("12", translate("12"), {band="b-20"}) -- not in US
	ch:value("13", translate("13"), {band="b-20"}) -- not in US
	ch:value("5u", translate("5u"), {band="b-40"})
	ch:value("6u", translate("6u"), {band="b-40"})
	ch:value("7u", translate("7u"), {band="b-40"})
	ch:value("8u", translate("8u"), {band="b-40"})
	ch:value("9u", translate("9u"), {band="b-40"})
	ch:value("10u", translate("10u"), {band="b-40"})
	ch:value("11u", translate("11u"), {band="b-40"})
	ch:value("12u", translate("12u"), {band="b-40"}) -- not in US
	ch:value("13u", translate("13u"), {band="b-40"}) -- not in US
	ch:value("1l", translate("1l"), {band="b-40"})
	ch:value("2l", translate("2l"), {band="b-40"})
	ch:value("3l", translate("3l"), {band="b-40"})
	ch:value("4l", translate("4l"), {band="b-40"})
	ch:value("5l", translate("5l"), {band="b-40"})
	ch:value("6l", translate("6l"), {band="b-40"})
	ch:value("7l", translate("7l"), {band="b-40"})
	ch:value("8l", translate("8l"), {band="b-40"}) -- not in US
	ch:value("9l", translate("9l"), {band="b-40"}) -- not in US
	ch:value("36", translate("36"), {band="a-20"})
	ch:value("40", translate("40"), {band="a-20"})
	ch:value("44", translate("44"), {band="a-20"})
	ch:value("48", translate("48"), {band="a-20"})
	ch:value("52", translate("52"), {band="a-20"})
	ch:value("56", translate("56"), {band="a-20"})
	ch:value("60", translate("60"), {band="a-20"})
	ch:value("64", translate("64"), {band="a-20"})
	ch:value("100", translate("100"), {band="a-20"})
	ch:value("104", translate("104"), {band="a-20"})
	ch:value("108", translate("108"), {band="a-20"})
	ch:value("112", translate("112"), {band="a-20"})
	ch:value("116", translate("116"), {band="a-20"})
	ch:value("120", translate("120"), {band="a-20"}) -- not in US
	ch:value("124", translate("124"), {band="a-20"}) -- not in US
	ch:value("128", translate("128"), {band="a-20"}) -- not in US
	ch:value("132", translate("132"), {band="a-20"})
	ch:value("136", translate("136"), {band="a-20"})
	ch:value("140", translate("140"), {band="a-20"})
	ch:value("144", translate("144"), {band="a-20", country="US"})
	ch:value("149", translate("149"), {band="a-20", country="US"})
	ch:value("153", translate("153"), {band="a-20", country="US"})
	ch:value("157", translate("157"), {band="a-20", country="US"})
	ch:value("161", translate("161"), {band="a-20", country="US"})
	ch:value("165", translate("165"), {band="a-20", country="US"})
	ch:value("40u", translate("40u"), {band="a-40"})
	ch:value("48u", translate("48u"), {band="a-40"})
	ch:value("56u", translate("56u"), {band="a-40"})
	ch:value("64u", translate("64u"), {band="a-40"})
	ch:value("104u", translate("104u"), {band="a-40"})
	ch:value("112u", translate("112u"), {band="a-40"})
	ch:value("120u", translate("120u"), {band="a-40"}) -- not in US
	ch:value("128u", translate("128u"), {band="a-40"}) -- not in US
	ch:value("136u", translate("136u"), {band="a-40"})
	ch:value("144u", translate("144u"), {band="a-40", country="US"})
	ch:value("153u", translate("153u"), {band="a-40", country="US"})
	ch:value("161u", translate("161u"), {band="a-40", country="US"})
	ch:value("36l", translate("36l"), {band="a-40"})
	ch:value("44l", translate("44l"), {band="a-40"})
	ch:value("52l", translate("52l"), {band="a-40"})
	ch:value("60l", translate("60l"), {band="a-40"})
	ch:value("100l", translate("100l"), {band="a-40"})
	ch:value("108l", translate("108l"), {band="a-40"})
	ch:value("116l", translate("116l"), {band="a-40"}) -- not in US
	ch:value("124l", translate("124l"), {band="a-40"}) -- not in US
	ch:value("132l", translate("132l"), {band="a-40"})
	ch:value("140l", translate("140l"), {band="a-40", country="US"})
	ch:value("149l", translate("149l"), {band="a-40", country="US"})
	ch:value("157l", translate("157l"), {band="a-40", country="US"})
	ch:value("36/80", translate("36"), {band="a-80"})
	ch:value("40/80", translate("40"), {band="a-80"})
	ch:value("44/80", translate("44"), {band="a-80"})
	ch:value("48/80", translate("48"), {band="a-80"})
	ch:value("52/80", translate("52"), {band="a-80"})
	ch:value("56/80", translate("56"), {band="a-80"})
	ch:value("60/80", translate("60"), {band="a-80"})
	ch:value("64/80", translate("64"), {band="a-80"})
	ch:value("100/80", translate("100"), {band="a-80"})
	ch:value("104/80", translate("104"), {band="a-80"})
	ch:value("108/80", translate("108"), {band="a-80"})
	ch:value("112/80", translate("112"), {band="a-80"})
	ch:value("132/80", translate("132"), {band="a-80"})
	ch:value("136/80", translate("136"), {band="a-80"})
	ch:value("140/80", translate("140"), {band="a-80"})
	ch:value("144/80", translate("144"), {band="a-80"})
	ch:value("149/80", translate("149"), {band="a-80"})
	ch:value("153/80", translate("153"), {band="a-80"})
	ch:value("157/80", translate("157"), {band="a-80"})
	ch:value("161/80", translate("161"), {band="a-80"})
...
--[[
	...
	nrate:value("-r 1", "Legacy 1 Mbps", {band="b-20"})
	nrate:value("-r 2", "Legacy 2 Mbps", {band="b-20"})
	nrate:value("-r 5.5", "Legacy 5.5 Mbps", {band="b-20"})
	nrate:value("-r 6", "Legacy 6 Mbps", {band="b-20"})
	nrate:value("-r 9", "Legacy 9 Mbps", {band="b-20"})
	nrate:value("-r 11", "Legacy 11 Mbps", {band="b-20"})
	nrate:value("-r 12", "Legacy 12 Mbps", {band="b-20"})
	nrate:value("-r 18", "Legacy 18 Mbps", {band="b-20"})
	nrate:value("-r 24", "Legacy 24 Mbps", {band="b-20"})
	nrate:value("-r 36", "Legacy 36 Mbps", {band="b-20"})
	nrate:value("-r 48", "Legacy 48 Mbps", {band="b-20"})
	nrate:value("-r 54", "Legacy 54 Mbps", {band="b-20"})
	nrate:value("-m 0", "MCS 0: 6.5 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 1", "MCS 1: 13 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 2", "MCS 2: 19.5 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 3", "MCS 3: 26 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 4", "MCS 4: 39 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 5", "MCS 5: 52 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 6", "MCS 6: 58.5 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 7", "MCS 7: 65 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 8", "MCS 8: 13 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 9", "MCS 9: 26 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 10", "MCS 10: 39 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 11", "MCS 11: 52 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 12", "MCS 12: 78 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 13", "MCS 13: 104 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 14", "MCS 14: 117 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 15", "MCS 15: 130 Mbps", {band="b-20"}, {band="a-20"})
	nrate:value("-m 0 ", "MCS 0: 13.5 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 1 ", "MCS 1: 27 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 2 ", "MCS 2: 40.5 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 3 ", "MCS 3: 54 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 4 ", "MCS 4: 81 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 5 ", "MCS 5: 108 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 6 ", "MCS 6: 121.5 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 7 ", "MCS 7: 135 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 8 ", "MCS 8: 27 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 9 ", "MCS 9: 54 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 10 ", "MCS 10: 81 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 11 ", "MCS 11: 108 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 12 ", "MCS 12: 162 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 13 ", "MCS 13: 216 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 14 ", "MCS 14: 243 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 15 ", "MCS 15: 270 Mbps", {band="b-40"}, {band="a-40"})
	nrate:value("-m 32 ", "MCS 32: 6 Mbps", {band="b-40"}, {band="a-40"})

	nrate:value("-m 0 ", "MCS 0: 29 Mbps", {band="a-80"})
	nrate:value("-m 1 ", "MCS 1: 58.5 Mbps", {band="a-80"})
	nrate:value("-m 2 ", "MCS 2: 87.5 Mbps", {band="a-80"})
	nrate:value("-m 3 ", "MCS 3: 117 Mbps", {band="a-80"})
	nrate:value("-m 4 ", "MCS 4: 175.5 Mbps", {band="a-80"})
	nrate:value("-m 5 ", "MCS 5: 234 Mbps", {band="a-80"})
	nrate:value("-m 6 ", "MCS 6: 263 Mbps", {band="a-80"})
	nrate:value("-m 7 ", "MCS 7: 292.5 Mbps", {band="a-80"})

	nrate:value("-m 8 ", "MCS 8: 58.5 Mbps", {band="a-80"})
	nrate:value("-m 9 ", "MCS 9: 117 Mbps", {band="a-80"})
	nrate:value("-m 10 ", "MCS 10: 175.5 Mbps", {band="a-80"})
	nrate:value("-m 11 ", "MCS 11: 234 Mbps", {band="a-80"})

	nrate:value("-m 12 ", "MCS 12: 351 Mbps", {band="a-80"})
	nrate:value("-m 13 ", "MCS 13: 468 Mbps", {band="a-80"})
	nrate:value("-m 14 ", "MCS 14: 526.5 Mbps", {band="a-80"})
	nrate:value("-m 15 ", "MCS 15: 585 Mbps", {band="a-80"})
	nrate:value("-m 16 ", "MCS 15: 270 Mbps", {band="a-80"})
	nrate:value("-m 17 ", "MCS 15: 175.5 Mbps", {band="a-80"})
	nrate:value("-m 18 ", "MCS 15: 270 Mbps", {band="a-80"})
	nrate:value("-m 19 ", "MCS 15: 270 Mbps", {band="a-80"})
	nrate:value("-m 20 ", "MCS 15: 270 Mbps", {band="a-80"})
	nrate:value("-m 21 ", "MCS 15: 702 Mbps", {band="a-80"})
	nrate:value("-m 22 ", "MCS 15: 789.5 Mbps", {band="a-80"})
	nrate:value("-m 23 ", "MCS 15: 877.5 Mbps", {band="a-80"})
