...
vlanid = s:option(Value, "vlan8021q", translate("Enter 802.1Q VLAN ID [0-4094]:"))

function iface.write(self, section, value)
	local vlan = vlanid:formvalue(section)
...
function vlanid.write(self, section, value)
	local iface = iface:formvalue(section)
	buildifname = iface.."."..value
	m.uci:set("layer2_interface_vlan", section, "ifname", buildifname )
	m.uci:set("layer2_interface_vlan", section, "vlan8021q", value )
end
