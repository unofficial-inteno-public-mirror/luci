...
module("luci.controller.support.system", package.seeall)

function index()
	entry({"support", "system"}, alias("support", "system", "system"), _("System"), 30).index = true
	entry({"support", "system", "system"}, cbi("admin_system/system"), _("System"), 1)
	entry({"support", "system", "clock_status"}, call("action_clock_status"))

	entry({"support", "system", "support"}, cbi("admin_system/admin"), _("Administration"), 2)

	entry({"support", "system", "flashops"}, call("action_flashops"), _("Backup / Flash Firmware"), 70)
	entry({"support", "system", "flashops", "backupfiles"}, form("admin_system/backupfiles"))

	entry({"support", "system", "reboot"}, call("action_reboot"), _("Reboot"), 90)
end
